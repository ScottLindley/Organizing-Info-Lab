...
public class Main {
    ...
    public static int[] findLargestAndSmallest(int array[]) {
        ...
        int[] resultArray = {minValue, maxValue};
        return resultArray;
    }
    ...
    public static int sumOfTwoLargest(List intList) {
        ...
        //Custom helper method 'findTwoLargest' found below
        int[] highestAndSecond = findTwoLargest(intList);
        return highestAndSecond[0]+highestAndSecond[1];
    }
    ...
    public static int[] findTwoLargest(List intList) {
        int secondHighestValue = (int) intList.get(0);
        int maxValue = (int) intList.get(0);
        for (Object i : intList) {
            if (maxValue < (int) i) {
                maxValue = (int) i;
            }
        }
        if(maxValue == secondHighestValue){
            secondHighestValue = (int)intList.get(1);
        }
        for (Object i : intList) {
            if ((secondHighestValue < (int) i) && ((int) i < maxValue)) {
                secondHighestValue = (int) i;
            }
        }
        int[] result = {maxValue, secondHighestValue};
        return result;
    }
}
